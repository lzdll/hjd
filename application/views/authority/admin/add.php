...
<div class="l_p30">
    ...
    <div class="t_list1 t_borderB">
            ...
            <ul class="clearfix">
                <li>
                    <b>登录名：</b>
                    <input type="text" placeholder="登录名" class="t_input t_mr10"  name="login_name"  id="login_name" />
                </li>
                <li>
                    <b>真实姓名：</b>
                    <input type="text" placeholder="真实姓名" class="t_input t_mr10"  name="real_name"  id="real_name" />
                </li>
                <li>
                    <b>密码：</b>
