			...
			<form class="layui-form autolayblock">
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
					  <input type="text" name="title" placeholder="米家小程序" disabled class="layui-input" />
					</div>
				  </div>
				  <div class="layui-form-item">
					...
					<div class="layui-input-block">
						<div class="areabox">
						  <textarea disabled class="" >米家小程序米家小程序米家小程序米家小程序米家小程序米家小程序</textarea>
						</div>
					</div>
				  </div>
				  <div class="layui-form-item">
					...
					<div class="layui-input-block">
					  <input type="radio" name="sex" value="01" title="H5" disabled />
					  <input type="radio" name="sex" value="02" title="android apk" disabled />
					  <input type="radio" name="sex" value="03" title="小程序" checked=""  disabled />
					</div>
				  </div>
				  <div class="layui-form-item">
					<label class="layui-form-label">小程序路径：</label>
					<div class="layui-input-block">
						<input type="text" name="title"  placeholder="https://www.baidu.com/index.php?tn=56060048_4_pg&ch=12" disabled class="layui-input" />
					</div>
				  </div>
				  <div class="layui-form-item">
				  ...
				  <div class="layui-form-item">
					...
					<div class="layui-input-block">
					  <input type="text" name="title"  placeholder="name" disabled class="layui-input" />
					</div>
				  </div>
				  <div class="layui-form-item">
					<label class="layui-form-label">URL：</label>
					<div class="layui-input-block">
					  <input type="text" name="title"  placeholder="https://www.baidu.com/" disabled class="layui-input" />
					</div>
				  </div>
				  <div class="layui-form-item">
					<label class="layui-form-label">小程序ID</label>
					<div class="layui-input-block">
					  <input type="text" name="title"  placeholder="小程序ID" disabled class="layui-input" />
					</div>
				  </div>
				  <div class="layui-form-item">
					<label class="layui-form-label">APP ID</label>
					<div class="layui-input-block">
					  <input type="text" name="title"  placeholder="APP ID" disabled class="layui-input" />
					</div>
				  </div>
				  <div class="layui-form-item">
					<label class="layui-form-label">icon：</label>
				  ...
				  <div class="layui-form-item">
					<div class="layui-input-block formopearbtn">
					  ...
					  <button class="layui-btn addbtn" lay-submit="" lay-filter="demo1">通过审核</button>
					</div>
				  </div>
			</form>
		</div>
